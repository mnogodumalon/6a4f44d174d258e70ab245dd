// Auto-generated. Per-entity form-enhancements config for "Wartungsverträge".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: [
    'kunde',
    'anlagentyp',
    { row: ['anlagenstandort_strasse', 'anlagenstandort_hausnummer'], cols: '2fr 1fr' },
    { row: ['anlagenstandort_plz', 'anlagenstandort_ort'], cols: '1fr 2fr' },
    'wartungsintervall',
    'letzte_wartung',
    'naechste_wartung',
    'wartungsstatus',
  ...
  defaults: {
    'naechste_wartung': { kind: 'todayOffset', days: 365 },
    'wartungsstatus': { kind: 'lookup', key: 'geplant', label: 'Geplant' },
  },
  computed: {},
};
